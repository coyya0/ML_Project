...
bool run(int width, int height, int channels, int kernel_width);
...
int main(int argc, char** argv)
{
    ...
    bool result = run(width, height, channels, kernel_width);
...
bool run(int width, int height, int channels, int kernel_width)
{
    ...
    printf("[Kernel ] Throughput = %.4f GB/s, Time = %.5f ms\n",
